...
class Telinga_tengah extends StatelessWidget{
  Widget gambar = Container(
   ...
   Widget gambar4 = Container(
    child: Image.asset(
      'images/tulang teliga tengah.jpg'),
  );
...
class Telinga_bagian_dalam extends StatelessWidget{
  Widget gambar = Container(
   ...
   Widget gambar3 = Container(
    child: Image.asset(
      'images/tiga bagian labirin tulang.jpg'),
  );
   Widget gambar4 = Container(
    child: Image.asset(
      'images/Struktur koklea, dan batas duktus koklea.jpg'),
  );
    Widget gambar5 = Container(
    child: Image.asset(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                text:
                 ...
                 TextSpan(
                text:
                    ' Cabang timpani anterior (dari arteri maksilaris). ',
                style: TextStyle( fontWeight: FontWeight.bold)), 
                TextSpan(
                text:
                ...
                style: TextStyle( fontWeight: FontWeight.bold)), 
                  TextSpan(
                text:
                    ' mensuplai duktus koklea.'),
                           TextSpan(
                text:
                    ' Cabang vestibular (x2) -',
                style: TextStyle( fontWeight: FontWeight.bold)),  
                   TextSpan(
                text:
...
class Orbit_Tulang extends StatelessWidget{
   ...
   Widget gambar3 = Container(
    child: Image.asset(
      'images/diagram suplai ateri ke mata.jpg'),
  );
    Widget gambar4 = Container(
    child: Image.asset(
      'images/bukaan utama ke orbit.jpg'),
    );
    Widget dis = Container(
    padding: const EdgeInsets.all(10.0),
    child: RichText(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                style: TextStyle( fontWeight: FontWeight.bold)), 
                      TextSpan(
                text:
                   ' Terletak di pembukaan kanal optik, foramen optik. '),
                       TextSpan(
                text: ' Basis – ',
                style: TextStyle( fontWeight: FontWeight.bold)), 
                         TextSpan(
...
class Otot_otot_Ekstraokular extends StatelessWidget{
   ...
   Widget gambar3 = Container(
    child: Image.asset(
      'images/Lateral view of the extraocular muscles.jpg'),
  );
...
class Bola_Mata extends StatelessWidget{
   ...
   Widget gambar2 = Container(
    child: Image.asset(
      'images/Kornea dan sklera mata.jpg'),
  );
   Widget gambar3 = Container(
    child: Image.asset(
      ...
      text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                style: TextStyle(fontWeight: FontWeight.bold)), 
               TextSpan(
              text: ' lapisan jaringan ikat dan pembuluh darah. Ini memberikan nutrisi ke lapisan luar retina. '),
               TextSpan(
                text:
                    ' Badan siliaris – ',
                style: TextStyle(fontWeight: FontWeight.bold)), 
                  TextSpan(
              text: ' terdiri dari dua bagian – otot siliaris dan prosesus siliaris. Otot siliaris terdiri dari kumpulan serat otot polos. Ini melekat pada lensa mata oleh proses siliaris. Badan siliaris mengontrol bentuk lensa, dan berperan dalam pembentukan akuos humor.'),
              TextSpan(
                text:
                    ' Iris –',
                style: TextStyle(fontWeight: FontWeight.bold)), 
      ...
      text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                ...
                style: TextStyle(fontWeight: FontWeight.bold)), 
               TextSpan(
              text: ' Otot levator palpebra superioris dan otot tarsal superior keduanya berfungsi untuk membuka kelopak mata. Mereka hanya ada di kelopak mata atas.'),
               TextSpan(
                text:
                    ' Penghubung ',
                style: TextStyle(fontWeight: FontWeight.bold)), 
                  TextSpan(
              text: ' Konjungtiva palpebra membentuk lapisan terdalam dari kelopak mata. \n\n Ini adalah selaput lendir tipis , yang dipantulkan ke sklera bola mata (konjungtiva bulbi).'),
                 ]),
      textAlign: TextAlign.justify,
    ),
  );
...
class langit_langit extends StatelessWidget{
   ...
   Widget gambar4 = Container(
    child: Image.asset(
      'images/Lokasi tonsil palatina di orofaring.jpg'),
  );
  Widget gambar5 = Container(
    child: Image.asset(
      'images/Pandangan labial dan lingual dari molar pertama rahang atas.jpg'),
